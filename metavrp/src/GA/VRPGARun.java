...
import GA.support.GAParameters;
import GA.operators.*;
...
public class VRPGARun {
    ...
    public VRPGARun(GAParameters params, CostMatrix costMatrix){
            
        int popSize = params.getPopSize();
        int nrVehicles = params.getNrVehicles();
        ...
        int nrNodes = costMatrix.getSize();

        int generation=0;
        long start = System.currentTimeMillis();
        
        // Create the Gene List
        GeneList geneList = new GeneList(nrVehicles,nrNodes);
